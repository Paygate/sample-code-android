...
public class VaultDeleteApi {
    ...
    /**
     * {@code VaultDeleteApi} builder static inner class.
     */
    public static final class Builder {
        ...
        /**
         * Returns a {@code VaultDeleteApi} built from the parameters previously set.
         *
         * @return a {@code VaultDeleteApi} built with parameters of this {@code VaultDeleteApi.Builder}
         */
        public VaultDeleteApi build() {
            return new VaultDeleteApi(this);
        }
    }
}
