 ...
 */
public class VaultLookupFragment extends BaseFragment {

    public static VaultLookupFragment newInstance() {

        Bundle args = new Bundle();

        VaultLookupFragment fragment = new VaultLookupFragment();
